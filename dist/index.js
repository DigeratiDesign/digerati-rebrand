...
(() => {
  ...
  var tallyModal = () => {
    ...
    if (!openLinks.length || !modal || !closeBtn || !iframe)
      return;
    ...
    const observer = new IntersectionObserver(
      (entries, obs) => {
        entries.forEach((entry) => {
          ...
          if (!entry.isIntersecting || img.dataset.htDone)
            return;
...
`, template.innerHTML.trim());
  ...
  // src/digerati/reasonGenerator.ts
  init_live_reload();
  var reasonGenerator = () => {
        ...
        onSplit(self) {
          return gsap.from(self.lines, {
            ...
            scrollTrigger: {
              ...
              scrub: true,
              onUpdate: (self2) => console.log("progress:", self2.progress.toFixed(2))
            }
          });
        }
      });
